...
/**
 * This function takes a schema, and optional key, and returns a function which
 * takes JSON as input and returns a normalized object of entities suitable for
 * use in the Redux Store.
 * @param {schema} schema - Normalizr Schema object.
 * @param {string} key - Data key the results are returned under (optional).
 */
export const normalizeEntities = schema => json => normalize(json.data, schema)
